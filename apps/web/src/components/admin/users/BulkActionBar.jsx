...
const BulkActionBar = ({ selectedCount, onClear, onBulkDelete, onBulkActivate, onBulkSuspend }) => {
  return (
    <AnimatePresence>
      {selectedCount > 0 && (
        <motion.div
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="sm" className="text-background hover:bg-background/20 hover:text-background h-8" onClick={onBulkSuspend}>
