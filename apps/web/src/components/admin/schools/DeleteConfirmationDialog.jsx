        ...
        <AlertDialogHeader>
          ...
          {itemType === 'School' && childCount > 0 && (
            <div className="mt-4 p-3 bg-destructive/5 border border-destructive/20 rounded-[var(--radius-md)] text-sm text-destructive-foreground font-medium">
              Warning: This school has {childCount} users. Deleting it will affect all associated users and their access.
            </div>
          )}
          
          {itemType === 'User' && (
            <div className="mt-4 p-3 bg-destructive/5 border border-destructive/20 rounded-[var(--radius-md)] text-sm text-destructive-foreground font-medium">
              Warning: This user will be permanently deleted and lose all access.
            </div>
          )}
        </AlertDialogHeader>
