...
const Table = React.forwardRef(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-[var(--radius-lg)] border border-border/50 shadow-soft-sm bg-card">
    <table
      ref={ref}
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border/50 transition-base hover:bg-muted/30 data-[state=selected]:bg-muted/50",
      className
    )}
    {...props} />
))
