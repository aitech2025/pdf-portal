...
export const registerSchoolCategoryRoutes = async (app) => {
    ...
    app.post("/api/schools/:school_id/categories", { preHandler: requirePermission(PERMISSIONS.SCHOOL_MANAGE) }, async (request, reply) => {
        const params = z.object({ school_id: z.string() }).parse(request.params);
        const body = z
            .object({
    ...
    app.delete("/api/schools/:school_id/categories/:category_id", { preHandler: requirePermission(PERMISSIONS.SCHOOL_MANAGE) }, async (request, reply) => {
